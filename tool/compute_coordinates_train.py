...
model = load_model("/content/DLProject/pose_estimator.h5")
...
input_folder = '/content/DLProject/deepfashion/fashion_resize/train'
output_path = '/content/DLProject/results/train_keypoints/pckh.csv'
